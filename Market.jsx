      ...
      <section className="market-section">
        ...
        <table className="market-table">
          ...
          <tbody>
            <tr>
              <td>Rice</td>
              <td>₹65.60</td> {/* ₹ converted from $0.80 */}
              <td>+2.5%</td>
              <td>High</td>
              <td>Rising</td>
            </tr>
            <tr>
              <td>Wheat</td>
              <td>₹53.30</td> {/* ₹ converted from $0.65 */}
              <td>-1.2%</td>
              <td>Moderate</td>
              <td>Falling</td>
            </tr>
            <tr>
              <td>Corn</td>
              <td>₹41.00</td> {/* ₹ converted from $0.50 */}
              <td>+1.8%</td>
              <td>High</td>
              <td>Stable</td>
            </tr>
            <tr>
              ...
              <td>₹98.40</td> {/* ₹ converted from $1.20 */}
              <td>+0.5%</td>
              <td>Moderate</td>
              <td>Stable</td>
            </tr>
            <tr>
              <td>Fruits (Mixed)</td>
              <td>₹123.00</td> {/* ₹ converted from $1.50 */}
              <td>+3.0%</td>
              <td>High</td>
              <td>Rising</td>
            </tr>
